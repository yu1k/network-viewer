...
function createManuItem(){
    ...
    // デバッグ用
    // menu.append(new MenuItem({ label: `key_pass: ${wlan.getWlanInfo().key_pass}` }));
    // menu.append(new MenuItem({ label: `whoami: ${wlan.getWlanInfo().whoami}` }));
...
// メニューバーのアイコン: ${__dirname}/../assets/wlan_logo_18_18.jpg
const backgroundIcon = path.join(__dirname, "../assets/wlan_logo_18_18.jpg");
